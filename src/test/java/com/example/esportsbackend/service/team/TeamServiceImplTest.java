...
class TeamServiceImplTest {
    ...
    void findAllTeams() {
        ...
        assertEquals(existingTeamList.get(0).id, team1.id);
        assertEquals(existingTeamList.get(0).name, team1.name);
        assertEquals(existingTeamList.get(0).currentMemberNumber, team1.currentMemberNumber);
        assertEquals(existingTeamList.get(1).id, team2.id);
        assertEquals(existingTeamList.get(1).name, team2.name);
        assertEquals(existingTeamList.get(1).currentMemberNumber, team2.currentMemberNumber);
